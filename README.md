...
1줄 소개 : 원하는 메뉴를 고르고 주문하기 버튼을 누르면 자동으로 가격을 계산해주는 시스템

사용한 플랫폼 : c#, .Windows Forms, Visual Studio, GitHub

사용한 컨트롤 : Label, TextBox, Button, checkbox, groupbox

사용한 기술과 구현한 기능:
Visual Studio를 이용한 UI 디자인

원하는 메뉴를 직접 선택할 수 있는 시스템
...
구현한 내용 (위 그림 참조)
- 아무 메뉴를 선택하지 않았는데 주문하기 버튼을 눌렀을 때 주문하기 버튼 위에 오류 메세지가 뜹니다.


실행화면 (과제3)
과제3 코드의 실행 스크린샷 (사진**)
<img width="1086" height="622" alt="탭으로 메뉴 이동 가능" src="https://github.com/user-attachments/assets/73040467-a992-4dac-ae9e-7aa6817ef950" />

구현한 내용 (위 그림 참조)
마우스를 쓰지 않고 키보드로만 메뉴를 선택하고 주문할 수 있음


실행화면 (과제4)
과제4 코드의 실행 스크린샷 (사진**)
<img width="1088" height="624" alt="메뉴 선택 시 실시간으로 주문창에 업데이트" src="https://github.com/user-attachments/assets/fbd31874-9f31-4048-be00-192b6a726f80" />

구현한 내용 (위 그림 참조)
메뉴 선택 시 실시간으로 주문창에 선택한 메뉴가 업데이트된다.
